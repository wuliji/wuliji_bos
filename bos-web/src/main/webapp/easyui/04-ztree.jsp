...
<body class="easyui-layout">
	...
	<div title="系统菜单" style="width: 200px" data-options="region:'west'">
		<div class="easyui-accordion" data-options="fit:true">
					...
					$(function(){
						...
						$('#but1').click(function(){
							...
							$('#mytabs').tabs("add",{
								...
								iconCls:'icon-edit',
								closable:true,
								content:'<iframe frameborder="0" height="100%" width="100%" src="https:wwww.baidu.com"></iframe>'
							});
							}
						});
					});
			...
			<div data-options="iconCls:'icon-edit'" title="面板三">
				<!-- 展示ztree效果：使用json数据构造ztree -->
			...
			<div data-options="iconCls:'icon-edit'" title="面板四">
			<!-- 展示ztree效果发送ajax请求获取简单json数据构造ztree -->
	...
	<div data-options="region:'center'">
		...
		<div id="mytabs" class="easyui-tabs" data-options="fit:true">
			...
			<div data-options="iconCls:'icon-edit'" title="面板三">333</div>
		</div>
	</div>
